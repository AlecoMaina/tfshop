                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-price">
                            <span class="product-price">KSH {{$product->sale_price}}</span>
                            <del><span class="product-price regprice">KSH {{$product->regular_price}}</span></del>
                        </div>                         
                        @else
                                ...
                                <li class="product-item">
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span class="product-price">Ksh {{$p_product->regular_price}}</span></div>
                                        </div>
                                    </div>
                                </li>                            
                            @endforeach
                            ...
                            @foreach ($related_products as $r_product)                               
                                <div class="product product-style-2 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">KSH {{ $r_product->regular_price}}</span></div>
                                    </div>
                                </div>
                            @endforeach
