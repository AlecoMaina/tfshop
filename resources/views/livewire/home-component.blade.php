                ...
                @foreach ($sliders as $slide)
                    <div class="item-slide">
                        ...
                        <div class="slide-info slide-1">
                            ...
                            <p class="sale-info">Only price: <span class="price">KSh{{$slide->price}}</span></p>
                ...
                @foreach ($sproducts as $sproduct)
                    <div class="product product-style-2 equal-elem ">
                        ...
                        <div class="product-info">
                            ...
                            <div class="wrap-price"><ins><p class="product-price">ksh{{$sproduct->sale_price}}</p></ins> <del><p class="product-price">ksh{{$sproduct->regular_price}}</p></del></div>
                        </div>
                    </div>
                @endforeach
                              ...
                              @foreach ($lproducts as $lproduct)                                
                                <div class="product product-style-2 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">KSh{{$lproduct->regular_price}}</span></div>
                                    </div>
                                </div>
                                @endforeach                             
                            </div>
                                ...
                                @foreach ($c_products  as $c_product)                                 
                                    <div class="product product-style-2 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span class="product-price">Ksh{{$c_product->regular_price}}</span></div>
                                        </div>
                                    </div>
                                @endforeach                                                         
