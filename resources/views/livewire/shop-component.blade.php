								...
								<div class="product product-style-3 equal-elem ">
									...
									<div class="product-info">
										...
										<div class="product-wish">
											...
											<a href="#" wire:click.prevent="removeFromWhishlist({{$product->id}})"> <i class="fa fa-heart fill-heart"></i> </a>
											  @else
											  <a href="#" wire:click.prevent="addToWhishlist({{$product->id}},'{{$product->name}}',{{$product->regular_price}})"> <i class="fa fa-heart"></i> </a>
											@endif
