			...
			<div class=" main-content-area">
				...
				<div class="summary">
					<div class="order-summary">
						...
						<p class="summary-info"><span class="title">Subtotal</span><b class="index">KSH {{Cart::instance('cart')->subtotal()}}</b></p>
						@if (Session::has('coupon'))
							<p class="summary-info"><span class="title">Discount({{Session::get('coupon')['code']}}) <a href="#"wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i></a></span><b class="index"> - KSH{{number_format($discount,2)}}</b></p>
							<p class="summary-info"><span class="title">subtotal with Discount</span><b class="index">KSH{{number_format($subtotalAfterDiscount,2)}} </b></p>
							<p class="summary-info"><span class="title">Tax({{config('cart.tax')}}%)</span><b class="index">KSH{{number_format($taxAfterDiscount,2)}} </b></p>							
							<p class="summary-info total-info "><span class="title">Total</span><b class="index">KSH{{number_format($totalAfterDiscount,2)}} </b></p>
						@else
						<p class="summary-info"><span class="title">Tax</span><b class="index">KSH {{Cart::instance('cart')->tax()}}</b></p>
						<p class="summary-info"><span class="title">Shipping</span><b class="index">Free Shipping</b></p>
						<p class="summary-info total-info "><span class="title">Total</span><b class="index">KSH {{Cart::instance('cart')->total()}}</b></p>
						@endif
			            ...
			            <div class="checkout-info">
							...
							<div class="summary-item">
								<form wire:submit.prevent="applyCouponCode">
									<h4 class="tilele-box">Coupon Code</h4>
